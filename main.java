...
class Equ {
    ...
    private Double parseFunction(String
        function, Integer startPos, Double[] args) {
        Double x = null;
    ...
    public void addFunction(String functionName, MathFunction
        function) {
...
public class main {
    ...
    private static String in_str(String msg) {
        try {
            System.in.available();
        } catch (Exception e) {
    ...
    private static int start(String...args) { // Start function
        System.out.println( // Print
            new Equ().parse( // Parse equation
                in_str( // Input
                    "Please enter a function: " // Message
                )
            )
        );
    ...
    public static void main(String[] args) { // Main function
        System.exit( // Exit
            start( // Function "Start" (Returns System.exit code)
                args // CMD Arguments
            )
        );
    }
